...
public class Frontend {
    ...
    public static void main(String[] args) throws IllegalArgumentException, NoSuchElementException {
        ...
        do {
            ...
            System.out.println("[9] N. charter and W. Dayton");
            System.out.println("[10] N. mills and Regent");
            System.out.println("[11] N. orchard and campus");
            System.out.println("[12] N. orchard and Regent");
            System.out.println("[13] N. orchard and spring");
            System.out.println("[14] N.brooks and W. Dayton");
            System.out.println("[15] N.mills and campus");
            System.out.println("[16] N.mills and Spring");
            System.out.println("[17] N.mills and W.Dayton");
            System.out.println("[18] Nicholas rec center");
            System.out.println("[19] Ogg");
            System.out.println("[20] Qudoba");
            System.out.println("[21] randell and dayton");
            System.out.println("[22] regent and radell");
            System.out.println("[23] Sellery");
            System.out.println("[24] Spring Street and randell");
            System.out.println("[25] the red zone maddison");
            System.out.println("[26] union south");
            System.out.println("[27] Witte");
            System.out.println("[28] Gordens");
            System.out.println("[29] Exit the program \n");
            ...
            if (menuInput > 29 || menuInput < 1) {
                System.out.println("The option you selected is out of range. Please select another");
            }

            if (menuInput != 0 && menuInput < 29 && menuInput > 0) {
                numLocations++;
                start = menuInput;
            }
        }  while(menuInput != 29 && numLocations == 0);


        do {
            System.out.println("Please select the ending destination.");
            System.out.println("[1] Buffalo wild wings");
            System.out.println("[2] campus and randell");
            System.out.println("[3] Computer science building");
            System.out.println("[4] E.Campus mall and johnson");
        ...
        } while (menuInput != 29 && numLocations == 1);
        ...
        do {
            System.out.println("The Shortest Path between " + strStart + " and " + strEnd + " is:");
